...
const downloadImg = require('./inc/downloaderImg')
const getSizeImage = require('../../../_commons/actions/getSizeImg');
const downloaderImgDesignSystem = require('./inc/downloaderImgDesignSystem')
				...
				if (pathGallery.length) {
					...
					if(subFolders.length) {
						for (let gallery of pathGallery) {
							...
							if(sizeImage > 0 && ((parseInt(sizeImage / 1000)) > 80) && gallery.search("gif") < 0
